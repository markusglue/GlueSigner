...
import net.sf.andpdf.pdfviewer.gui.DragRectView.OnUpCallback;
...
public class FullScrollView extends FrameLayout {
    protected static final String TAG = "FullScrollView";
    ...
    private boolean redirectTouches = false;

    
    public boolean touchesRedirectable() {
		return redirectTouches;
	}

	public void setTouchesRedireactable(boolean redirectTouches) {
		this.redirectTouches = redirectTouches;
	}
